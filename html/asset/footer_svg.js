...
@media (any-pointer:fine) {
    ...
    <main>
      <div class="frame">
        <h2 class="frame__title">Hildegard Rost</h2>
      </div>
      <div class="content">
        <div class="item">
          <figure class="thumb">
            ...
            >
              ...
              <image
                ...
                x="50"
                y="50"
                xlink:href="1.80b98c5b.jpg"
                height="350"
                width="250"
              />
            </svg>
            <figcaption class="thumb__caption">
              <p class="thumb__caption-title">
                Prow scuttle parrel provost Sail ho shrouds spirits boom
                mizzenmast yardarm.
              </p>
              <a class="thumb__caption-link">Explore</a>
            </figcaption>
          </figure>
          <div class="item__meta">
            <p class="item__meta-counter">01</p>
            <h3 class="item__meta-title">Custodis</h3>
            <p class="item__meta-detail">London, UK</p>
            <p class="item__meta-detail">2019</p>
          </div>
        </div>
        <div class="item">
          <figure class="thumb">
          ...
          <div class="item__meta">
            ...
            <h3 class="item__meta-title">Lunatia</h3>
            <p class="item__meta-detail">Madrid, Spain</p>
            <p class="item__meta-detail">2020</p>
          </div>
        </div>
        <div class="item">
          <figure class="thumb">
            <svg
              ...
              xmlns:xlink="http://www.w3.org/1999/xlink"
            >
              <filter id="c" data-type="displacementMap">
                <feTurbulence
                  type="fractalNoise"
          ...
          <div class="item__meta">
            ...
            <h3 class="item__meta-title">Makkaria</h3>
            <p class="item__meta-detail">Paris, France</p>
            <p class="item__meta-detail">2021</p>
          </div>
        </div>
        <div class="item">
          <figure class="thumb">
            <svg
              ...
              xmlns:xlink="http://www.w3.org/1999/xlink"
            >
              <filter id="d" data-type="displacementMap">
                <feTurbulence
                  type="turbulence"
          ...
          <div class="item__meta">
            ...
            <h3 class="item__meta-title">House Friend</h3>
            <p class="item__meta-detail">Constance, Germany</p>
            <p class="item__meta-detail">2022</p>
          </div>
        </div>
        <div class="item">
          <figure class="thumb">
            <svg
              ...
              xmlns:xlink="http://www.w3.org/1999/xlink"
            >
              <filter id="e" data-type="displacementMap">
                <feTurbulence
                  type="turbulence"
                  baseFrequency="0.1"
                  numOctaves="5"
          ...
          <div class="item__meta">
            ...
            <h3 class="item__meta-title">Green Eye</h3>
            <p class="item__meta-detail">Cape Town, South Africa</p>
            <p class="item__meta-detail">2023</p>
          </div>
        </div>
      </div>
    </main>
...
customElements.define("footer-svg", Footer);// modules are defined as an array
...
*/
  ...
  */
          ...
          _createClass(GridItem, [
            {
              ...
              value: function move() {
                ...
                var xstart = this.invertMovement
                  ? (0, _utils.getRandomNumber)(20, 70)
                  : (0, _utils.getRandomNumber)(40, 80);
                var ystart = this.invertMovement
                  ? (0, _utils.getRandomNumber)(10, 60)
                  : (0, _utils.getRandomNumber)(40, 80); // also moving inner image (max 50px on each side - to change this limit change it also in the CSS)

                var translationInnerVals = {
                  tx: 0,
                  ty: 0,
                };
                var xstartInner = this.invertMovement
                  ? (0, _utils.getRandomNumber)(0, 25)
                  : (0, _utils.getRandomNumber)(0, 50);
                var ystartInner = this.invertMovement
                  ? (0, _utils.getRandomNumber)(0, 25)
                  : (0, _utils.getRandomNumber)(0, 50);
                ...
                var render = function render() {
                  translationVals.tx = (0, _utils.lerp)(
                    ...
                    (0, _utils.map)(
                      ...
                      0,
                      winsize.width,
                      _this.invertMovement ? xstart : -xstart,
                      _this.invertMovement ? -xstart : xstart
                    ),
                    0.07
                  );
                  translationVals.ty = (0, _utils.lerp)(
                    ...
                    (0, _utils.map)(
                      ...
                      0,
                      winsize.height,
                      _this.invertMovement ? ystart : -ystart,
                      _this.invertMovement ? -ystart : ystart
                    ),
                    0.07
                  );
                  ...
                  translationInnerVals.tx = (0, _utils.lerp)(
                    translationInnerVals.tx,
                    (0, _utils.map)(
                      mousepos.x,
                      0,
                      winsize.width,
                      _this.invertMovement ? -xstartInner : xstartInner,
                      _this.invertMovement ? xstartInner : -xstartInner
                    ),
                    0.07
                  );
                  translationInnerVals.ty = (0, _utils.lerp)(
                    translationInnerVals.ty,
                    (0, _utils.map)(
                      mousepos.y,
                      0,
                      winsize.height,
                      _this.invertMovement ? -ystartInner : ystartInner,
                      _this.invertMovement ? ystartInner : -ystartInner
                    ),
                    0.07
                  );
    ...
    toeh: [
      ...
      { "../cursor": "LMRJ", "./grid": "A7Sp", "../utils": "MgTz" },
    ],
  },
  {},
  ["toeh"],
